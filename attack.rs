...
*/
fn compare_end(rainbow_table: &mut Vec<Node>, value: String//, start: u32, end: u32, signal: Arc<AtomicBool>
) -> u32 {
    for i in 0..NB_PASSWORD {
        ...
        return  i;
        /* 
        else if signal.load(Ordering::Relaxed) {
            // La valeur a été trouvée, arrêter le thread
            break;
        }*/
    }
    return 0;
...
/* 
fn pool_search(rainbow_table: &mut Vec<Node>, value: String) -> u32 {
